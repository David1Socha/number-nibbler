...
menu.start_button_font = love.graphics.newFont(main_font_path,menu.start_button_fontsize)
...
function menu:enter()
  ...
  menu.name_font = love.graphics.newFont(main_font_path,.0469*menu.width)
end
