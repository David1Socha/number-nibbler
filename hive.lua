...
function new_hive(question_type, difficulty)
  ...
  function hive:new_fly(box_size, col, row, prob_correct)
    ...
    function fly:draw()
      ...
      love.graphics.draw(self.img, rowcol_scaled.x+self.rx, rowcol_scaled.y+self.ry, 0, self.scale, self.scale)
      love.graphics.setColor(0, 0, 0)
      love.graphics.printf(self.text, rowcol_scaled.x + self.text_off.x+self.rx, rowcol_scaled.y + self.text_off.y +self.ry,0.356*self.box_size,"center")
    end
